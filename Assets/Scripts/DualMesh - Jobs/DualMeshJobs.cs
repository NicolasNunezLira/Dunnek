...
public class DualMeshJob : MonoBehaviour
{
    ...
    public NativeArray<float> terrainElev, sandElev, shadow;
    ...
    void Start()
    {
        ...
        duneModel = new ModelDMJ(slopeFinder, sandElev, terrainElev, resolution + 1, resolution + 1, slope, (int)windDirection.x, (int)windDirection.y,
    ...
    void Update()
    {
        ...
        else
        {
            ...
            dualMeshConstructor.ApplyHeightMapToMesh(sandGO.GetComponent<MeshFilter>().mesh, sandElev, resolution);
